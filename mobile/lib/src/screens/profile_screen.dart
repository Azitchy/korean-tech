          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Learner Profile', style: Theme.of(context).textTheme.headlineMedium?.copyWith(color: scheme.onPrimary)),
                const SizedBox(height: 4),
                Text('Connected account', style: TextStyle(color: scheme.onPrimary.withValues(alpha: 0.9))),
                const SizedBox(height: 8),
                Text('Profile badges and learning stats come from the backend.', style: TextStyle(color: scheme.onPrimary.withValues(alpha: 0.9))),
              ],
            ),
          ),
