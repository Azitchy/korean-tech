          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Student ID: ST-1024', style: TextStyle(color: scheme.onPrimary.withOpacity(0.9))),
                const SizedBox(height: 8),
                Text('IELTS premium learner', style: TextStyle(color: scheme.onPrimary.withOpacity(0.9))),
              ],
            ),
          ),
